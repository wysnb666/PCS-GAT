...
from MPC4plus.phase4.operations import CanonicalRuleSelector
...
def run_rule_phase4_pipeline(
    ...
    *,
    ...
    """
    Run the current baseline pipeline up to Phase 4 using the rule selector.

    Pipeline:
        Phase 1 -> Phase 2 (build G1, compute C, build M_C) -> Phase 4

    This function does not enter Phase 5 yet. It is intended for exporting
    Phase 4 decision traces and candidate-level training data.
    """
