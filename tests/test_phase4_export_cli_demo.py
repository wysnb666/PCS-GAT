...
#   python MPC4plus/experiments/cli/export_phase4_data.py ...
#
# Without this, Python may only put the script directory on sys.path,
# causing absolute imports like "from MPC4plus...." to fail.
